...
export function TasksFilesSidebar({
  ...
  return (
    <div
      className={cn(
        "border-l bg-background/95 backdrop-blur-sm  transition-all duration-300 ease-in-out flex flex-col h-screen",
    ...
    >
      ...
      {/* Tabs Content */}
      {!collapsed && (
        <Tabs defaultValue="todos" className="flex-1 flex flex-col h-[85%]">
